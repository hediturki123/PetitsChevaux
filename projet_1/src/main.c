...
int main() {
    ...
    */
    ...
    switch (numeroJoueur) {
        ...
        case 2:
        case 3:
            printf("Je suis le joueur %d. (pid=%d ; pidPere=%d ; maître ? %d)\n", numeroJoueur, getpid(), getppid(), getpid()==pidMaitre);
            break;
        case -1:
            printf("Je suis le maître du jeu ! (pid=%d : pidPere=%d ; maître ? %d)\n", getpid(), getppid(), getpid()==pidMaitre);
            break;
        default:
